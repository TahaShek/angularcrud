...
export class ProductService {
  ...
  HardDelete(_id:any){
    return this.http.delete(`http://localhost:1111/HardDeleteFromDataBase/HardDelete/${_id}`)
  }
  UpdateById(payload:any){
    return this.http.post('http://localhost:1111/UpdateDatainDataBase/UpdateDatabyId',payload)
  }
}
